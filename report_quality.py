...
if __name__ == "__main__":
    ...
    for line in sys.stdin:
        ...
        os.system("csplit --prefix ref_{0}_ ref_{0}.fa \"/>/\" \"{*}\"".format(contig_file))
        ...
        for i in range(1, 4):
            os.system("python homoeolog_assembly/compare_vcf.py {0}_0{1}.vcf ref_{1}.vcf >> {0}assembly_quality_{2}.tsv".format(args.ref_file, i, contig_file))